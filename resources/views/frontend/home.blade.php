...
@section('content')
<section class="hero-container" style="padding: 40px 0;">
    <div class="container">
        <div style="background: linear-gradient(135deg, #ebf5fb 0%, #ffffff 100%); 
                    padding: 60px 20px; 
                    border-radius: 20px; 
                    text-align: center; 
            ...
            <h1 style="font-family: 'Playfair Display', serif; color: #2c3e50; font-size: 2.5rem; margin-bottom: 15px;">
                Chào mừng bạn đến với <span style="color: #3498db;">Hiên Sách</span>
            </h1>
            <p style="color: #7f8c8d; font-size: 1.1rem; margin-bottom: 30px; max-width: 600px; margin-left: auto; margin-right: auto;">
                Nơi hội tụ những tác phẩm văn học kinh điển và hiện đại.
            </p>
            
            <a href="#featured-books" class="btn-shop" style="background-color: #3498db; color: white; padding: 12px 35px; border-radius: 25px; text-decoration: none; font-weight: 600; display: inline-block; transition: 0.3s;">
                Khám phá ngay <i class="fas fa-arrow-right" style="margin-left: 8px;"></i>
            </a>
        </div>
    </div>
</section>
...
<section class="featured-books container">
    <div class="section-header">
        <div style="background: linear-gradient(135deg, #3498db 0%, #ffffff 100%); 
                    padding: 30px 20px; 
                    border-radius: 20px; 
                    border: 1px solid #e1e8ed;
                    box-shadow: 0 4px 15px rgba(0,0,0,0.03);">
